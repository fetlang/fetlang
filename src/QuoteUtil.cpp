...
static bool isOctalCharacter(char c) { return (c >= '0' && c <= '7'); }
...
inline static char unescape(char c) { return escapeMap.at(c); }
...
std::string QuoteUtil::requote(const std::string& sequence) { return quote(unquote(sequence)); }
