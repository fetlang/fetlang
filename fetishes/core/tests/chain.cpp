...
TEST_CASE("Chain Test", "[chain][core]") {
	...
	const char* const sample_text3 =
		"Mmmm, yeah, your wife and kids died in that car crash. You like that, baby?\n";
	...
	SECTION("Chain/fraction test") {
		...
		std::map<std::pair<FractionInt, FractionInt>, const std::string> test_map = {
			...
			{{123456089, 1},
			 "one hundred and twenty three million, four hundred and fifty six thousand, and "
			 "eighty nine"},
			{{-123456089, 1},
			 "negative one hundred and twenty three million, four hundred and fifty six thousand, "
			 "and eighty nine"},
		};
